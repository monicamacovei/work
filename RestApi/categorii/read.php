  ...
  //execut interogarea bazei de date
    ...
    if($categorie=="marca"){
        ...
        $query = "SELECT MARCA FROM An2019 UNION SELECT MARCA FROM An2018 UNION SELECT MARCA FROM An2017 UNION SELECT MARCA FROM An2016 UNION SELECT MARCA FROM An2015";
            ...
            $query = "SELECT MARCA FROM An2019 UNION SELECT MARCA FROM An2018 UNION SELECT MARCA FROM An2017 UNION SELECT MARCA FROM An2016 UNION SELECT MARCA FROM An2015 LIMIT 7";
        }
        $stmt = $db->prepare($query);
        $stmt->execute();     
        $num = $stmt->rowCount();
